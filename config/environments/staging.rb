Dealsformommy::Application.configure do
  ...
  Dealsformommy::Application.config.middleware.use ExceptionNotifier,
    :email_prefix => "[ DFM Staging Exception ] ",
    :sender_address => %{"DFM staging exception notifier" <no-reply@dealsformommy.com>},
  ...
  config.action_controller.asset_host = "http://staging.media.dealsformommy.com"
